...
1. Reena applied for a job and got selected. She has been offered a job with a starting monthly salary of ` 8000, with an annual increment of ` 500 in her salary. Her salary (in `) for the 1st, 2nd, 3rd, . . . years will be, respectively 8000, 8500, 9000, . . . .
2. The lengths of the rungs of a ladder decrease uniformly by 2 cm from bottom to top (see Fig. 5.1). The bottom rung is 45 cm in length. The lengths (in cm) of the 1st, 2nd, 3rd, . . ., 8th rung from the bottom to the top are, respectively 45, 43, 41, 39, 37, 35, 33, 31
3. In a savings scheme, the amount becomes 5 times of itself after every 4 years. The maturity amount (in `) of an investment of ` 8000 after 3, 6, 9 and 12 years will be, respectively: 10000, 12500, 15625, 19531.25
...
(iv) The number of unit squares in squares with side 1, 2, 3, . . . units (see Fig. 5.2) are, respectively 1², 2², 3², . . . .
...
Let us denote the first term of an AP by *a1, second term by a2, . . ., nth term by an and the common difference by d. Then the AP becomes a1, a2, a3, . . ., an. So, a2 – a1 = a3 – a2 = . . . =  an – an – 1 = d*.
...
It is left as an exercise for you to explain why each of the lists above is an AP. You can see that *a, a + d, a + 2d, a + 3d, . . . represents an arithmetic progression where a is the first term and d* the common difference. This is called the general form of an AP.
...
For instance if the first term *a is 6 and the common difference d is 3, then the AP is 6, 9, 12, 15, . . . and if a is 6 and d is –3, then the AP is 6, 3, 0, –3, . . .*.
...
- a = 0, d = 1/2, the AP is 0, 1/2, 1, 3/2, 2, . . .
- a = 2, d = 0, the AP is 2, 2, 2, 2, . . .

So, if you know what a and d are, you can list the AP. What about the other way round? That is, if you are given a list of numbers can you say that it is an AP and then find a and d? Since a is the first term, it can easily be written. We know that in an AP, every succeeding term is obtained by adding d to the preceding term. So, d is found by subtracting any term from its succeeding term, i.e., the term which immediately follows it should be the same for an AP.
...
i.e., ak + ₁ – aₖ is the same every time.
...
It would be ` (8000 + 500) = ` 8500. In the same way, we can find the monthly salary for the 3rd, 4th and 5th year by adding 500 to the salary of the previous year.

So, the salary for the 3rd year = ` (8500 + 500) = ` (8000 + 500 + 500) = ` (8000 + 2 × 500) = ` [8000 + (3 – 1) × 500] (for the 3rd year) = ` 9000

Salary for the 4th year = ` (9000 + 500) = ` (8000 + 500 + 500 + 500) = ` (8000 + 3 × 500) = ` [8000 + (4 – 1) × 500] (for the 4th year) = ` 9500

Salary for the 5th year = ` (9500 + 500) = ` (8000 + 500 + 500 + 500 + 500) = ` (8000 + 4 × 500) = ` [8000 + (5 – 1) × 500] (for the 5th year) = ` 10000
...
Looking at the pattern, we can say that the nth term aₙ = a + (n – 1) d.

So, the nth term aₙ of the AP with first term a and common difference d is given by aₙ = a + (n – 1) d.
...
a is also called the general term of the AP an. If there are m terms in the AP, then m represents the last term which is sometimes also denoted by l.
...
As an = a + (n – 1) d, we have – 81 = 21 + (n – 1)(– 3)
...
Next, we want to know if there is any n for which an = 0. If such an n is there, then 21 + (n – 1)(–3) = 0, i.e., 3(n – 1) = 21, i.e., n = 8
...
As aₖ + ₁ – aₖ is the same for k = 1, 2, 3, etc., the given list of numbers is an AP.
...
Is this an AP? Yes it is. Here, a = 12, d = 3, aₙ = 99.

As aₙ = a + (n – 1) d, we have:
...
It is an AP as the difference between the consecutive terms in the list is 80, i.e., d = 80. Also, a = 80. So, to find the interest at the end of 30 years, we shall find a30.
...
So, S = 100/2 * 101 = 5050, i.e., the sum = 5050.
...
a + (n – 1) d. Let S denote the sum of the first n terms of the AP. We have
...
We can also write this as S = n [a + a + (n – 1) d] / 2

i.e., S = n (a + aₙ) / 2 (3)

Now, if there are only n terms in an AP, then aₙ = l, the last term.
...
we have S = 21 2 100 (21 - 1) 50 = 21 200 1000
...
We also use Sn in place of S to denote the sum of first n terms of the AP. We use S20 to denote the sum of the first 20 terms of an AP. The formula for the sum of first n terms involves four quantities S, a, d and n. If we know any three of them, we can find the fourth.

Remark: The nth term of an AP is the difference of the sum to first n terms and the sum to first (n - 1) terms of it, i.e., an = Sn - Sn - 1.
...
Therefore, S = 22 16 21 (5) = 11(16 - 105) = 11(-89) = -979.
...
i.e., 910 = 91d or, d = 10 Therefore, a20 = 10 + (20 – 1) × 10 = 200, i.e. 20th term is 200.
...
So, 78 = n/2 (48 + (n - 1)(-3)) = n/2 (48 - 3n + 3) = n/2 (51 - 3n)

or 3n² – 51n + 156 = 0 or n² – 17n + 52 = 0 or (n – 4)(n – 13) = 0 or n = 4 or 13
...
Using the formula Sn = n/2 (a + l) for the sum of the first n terms of an AP, we have S1000 = 1000/2 (1 + 1000) = 500 × 1001 = 500500
...
Therefore, S = n (n + 1) / 2 or S = (n - 1) n / 2
...
Therefore, S24 = 24 / 2 (5 + (24 - 1) × 2) = 12 × 10 + 46 = 672
...
3. given a12 = 37, d = 3, find an and S12.
...
8. given an = 4, d = 2, S = –14, find n and a.
...
Show that a1, a2, . . ., an form an AP where
...
` 200 for the first day,

` 250 for the second day,

` 300 for the third day, etc., the penalty for each succeeding day being ` 50 more than for the preceding day.
...
[Hint : Length of successive semicircles is respectively.] l₁, l₂, l₃, l₄, . . . with centres at A, B, A, B, . . .
...
[Hint : Sx – 1 = S – S49]
5. A small terrace at a football ground comprises of 15 steps each of which is 50 m long and built of solid concrete. Each step has a rise of 1⁄2 m and a tread of 1⁄4 m. (see Fig. 5.8). Calculate the total volume of concrete required to build the terrace.

[Hint : Volume of concrete required to build the first step = 1⁄4 m3]
...
d to the preceding term, except the first term. The fixed number
d is called the common difference. The general form of an AP is
a, a + d, a + 2d, a + 3d, . . .
2. A given list of numbers a₁, a₂, a₃, . . . is an AP, if the differences
a₂ – a₁, a₃ – a₂, a₄ – a₃, . . . give the same value, i.e., if
aₖ₊₁ – aₖ is the same for different values of k.
